...
simple = testCase "simple" $ do
  ...
  (@?= (0, 1, 1, 1)) =<< MF.getEdge gr 0
  (@?= (0, 2, 1, 1)) =<< MF.getEdge gr 1
  (@?= (1, 3, 1, 1)) =<< MF.getEdge gr 2
  (@?= (2, 3, 1, 1)) =<< MF.getEdge gr 3
  (@?= (1, 2, 1, 0)) =<< MF.getEdge gr 4
...
notSimple = testCase "notSimple" $ do
  ...
  (@?= (0, 1, 1, 1)) =<< MF.getEdge gr 0
  (@?= (0, 1, 2, 2)) =<< MF.getEdge gr 1
  (@?= (0, 1, 3, 3)) =<< MF.getEdge gr 2
  (@?= (0, 1, 4, 4)) =<< MF.getEdge gr 3
  (@?= (0, 1, 5, 5)) =<< MF.getEdge gr 4
...
flowMax = testCase "flowMax" $ do
  ...
  gr <- MF.build g
  (@?= maxBound) =<< MF.flow gr 0 2

  (@?= (0, 1, maxBound, 0)) =<< MF.getEdge gr 0
  (@?= (1, 0, maxBound, 0)) =<< MF.getEdge gr 1
  (@?= (0, 2, maxBound, maxBound)) =<< MF.getEdge gr 2
